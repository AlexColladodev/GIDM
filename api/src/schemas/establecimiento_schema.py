...
class EstablecimientosSchema(Schema):
    ...
    ofertas = fields.List(fields.Str(), required=False, load_default=[])
    eventos = fields.List(fields.Str(), required=False, load_default=[])
    reviews = fields.List(fields.Str(), required=False, load_default=[])
